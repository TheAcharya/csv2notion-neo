...
19. TestNotionDBCacheBehavior
    - test_rows_cache_not_set_on_fetch_failure
    - test_rows_cache_set_on_successful_fetch
...
# ============================================================================
# 19. TestNotionDBCacheBehavior - NotionDB caching and error handling
# ============================================================================
class TestNotionDBCacheBehavior:
    ...
    def test_rows_cache_not_set_on_fetch_failure(self):
        ...
        """
        mock_client = Mock()
        mock_client.query_database.side_effect = Exception(
